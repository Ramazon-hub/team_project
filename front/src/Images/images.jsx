...
function Bin() {
    return (
        <svg width="40px" height="40px" viewBox="4 4 16 20" role="img" xmlns="http://www.w3.org/2000/svg"
        aria-labelledby="binIconTitle" stroke="#008dce" strokeWidth="2" strokeLinecap="round"
            strokeLinejoin="round" fill="#fff" color="#000000">
